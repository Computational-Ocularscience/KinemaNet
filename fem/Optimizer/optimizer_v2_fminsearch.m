clear; clc;
root_folder = 'G9M1_Material_Model_Results';
n_timesteps = 30;

addpath('D:\FEM\Optimizer');

% Initial guess: [sigma, k]
x0 = [15, 15];  % Start with sigma = 5, k = 3

% Run fminsearch
[x_opt, fval] = fminsearch(@(x) loss_wrapper(x, root_folder, n_timesteps), x0);
